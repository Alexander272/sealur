...
// func (r *UserRepo) Get(ctx context.Context, req *user_api.GetUser) (user user_model.User, err error) {
// 	var query, param string
// 	if req.Login != "" {
// 		query = fmt.Sprintf("SELECT id, email, password FROM %s WHERE login = $1 AND confirmed=true", UserTable)
// 		param = req.Login
// 	} else {
// 		query = fmt.Sprintf("SELECT id, organization, name, email, city, position, phone FROM %s WHERE id = $1", UserTable)
// 		param = req.Id
// 	}
...
// func (r *UserRepo) GetAll(ctx context.Context, req *user_api.GetAllUser) (users []user_model.User, err error) {
// 	search := ""
// 	if req.Search.Value != "" {
// 		search = " AND ("
// 		tmp := []string{}
...
// func (r *UserRepo) GetNew(ctx context.Context, req *user_api.GetNewUser) (users []models.User, err error) {
...
// func (r *UserRepo) Create(ctx context.Context, user *user_api.CreateUser) error {
...
// func (r *UserRepo) Confirm(ctx context.Context, user *user_api.ConfirmUser) (models.ConfirmUser, error) {
...
// func (r *UserRepo) Delete(ctx context.Context, user *user_api.DeleteUser) (models.DeleteUser, error) {
