...
func (h *UserHandler) GetByParam(ctx context.Context, req *user_api.GetUsersByParam) (*user_api.AnalyticsUsers, error) {
	users, err := h.service.GetFullAnalytics(ctx, req)
	if err != nil {
		return nil, err
	}
	return &user_api.AnalyticsUsers{Users: users}, nil
}
