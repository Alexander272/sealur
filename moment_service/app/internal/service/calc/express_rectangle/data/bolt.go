...
func (s *DataService) getBoltData(ctx context.Context, bolt *express_rectangle_model.BoltData, temp float64,
) (boltData *express_rectangle_model.BoltResult, err error) {
	boltData = &express_rectangle_model.BoltResult{
		Count: bolt.Count,
	}
