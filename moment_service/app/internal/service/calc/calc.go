...
import (
	...
	calc_flange_old "github.com/Alexander272/sealur/moment_service/internal/service/calc/flange_old"
...
func NewCalcServices(flange *flange.FlangeService, gasket *gasket.GasketService, materials *materials.MaterialsService) *CalcService {
	...
	return &CalcService{
		FlangeOld:  calc_flange_old.NewFlangeService(graphic, flange, gasket, materials),
