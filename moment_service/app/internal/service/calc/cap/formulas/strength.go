...
func (s *FormulasService) auxiliaryFormulas(data models.DataCap, req *calc_api.CapRequest, result *calc_api.CapResponse) *cap_model.AuxiliaryFormulas {
	...
	fEpAt201 := strings.ReplaceAll(strconv.FormatFloat(data.Flange.EpsilonAt20, 'G', 3, 64), "E", "*10^")
	fEpAt202 := strings.ReplaceAll(strconv.FormatFloat(data.Cap.EpsilonAt20, 'G', 3, 64), "E", "*10^")
	fEp1 := strings.ReplaceAll(strconv.FormatFloat(data.Flange.Epsilon, 'G', 3, 64), "E", "*10^")
	fEp2 := strings.ReplaceAll(strconv.FormatFloat(data.Cap.Epsilon, 'G', 3, 64), "E", "*10^")

	typeBolt := strconv.FormatFloat(s.typeBolt[req.Data.Type.String()], 'G', 3, 64)
	...
	Yf1 := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Strength.Auxiliary.Flange.Yf, 'G', 3, 64), "E", "*10^")
	Yk1 := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Strength.Auxiliary.Flange.Yk, 'G', 3, 64), "E", "*10^")
	A1 := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Strength.Auxiliary.Flange.A, 'G', 3, 64), "E", "*10^")
	E1 := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Strength.Auxiliary.Flange.E, 'G', 3, 64), "E", "*10^")
	B1 := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Strength.Auxiliary.Flange.B, 'G', 3, 64), "E", "*10^")
	Y := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Strength.Auxiliary.Cap.Y, 'G', 3, 64), "E", "*10^")
	...
	if data.FlangeType == cap_model.FlangeData_free {
		fEpsilonKAt201 := strings.ReplaceAll(strconv.FormatFloat(data.Flange.Ring.EpsilonAt20, 'G', 3, 64), "E", "*10^")
		fEpsilonK1 := strings.ReplaceAll(strconv.FormatFloat(data.Flange.Ring.Epsilon, 'G', 3, 64), "E", "*10^")
...
func (s *FormulasService) auxFlangeFormulas(
	...
	if data.Ring != nil {
		epsilonAt20 = strings.ReplaceAll(strconv.FormatFloat(data.Ring.EpsilonAt20, 'G', 3, 64), "E", "*10^")
		dk = strconv.FormatFloat(data.Ring.Dk, 'G', 3, 64)
		dnk = strconv.FormatFloat(data.Ring.Dnk, 'G', 3, 64)
		hk = strconv.FormatFloat(data.Ring.Hk, 'G', 3, 64)
		ds = strconv.FormatFloat(data.Ring.Ds, 'G', 3, 64)
	}
...
func (s *FormulasService) auxCapFormulas(
	...
	Dcp_ := strings.ReplaceAll(strconv.FormatFloat(Dcp, 'G', 3, 64), "E", "*10^")
	DOut_ := strings.ReplaceAll(strconv.FormatFloat(flange.DOut, 'G', 3, 64), "E", "*10^")
	S0_ := strings.ReplaceAll(strconv.FormatFloat(flange.S0, 'G', 3, 64), "E", "*10^")
	D_ := strings.ReplaceAll(strconv.FormatFloat(flange.D, 'G', 3, 64), "E", "*10^")
	h_ := strings.ReplaceAll(strconv.FormatFloat(flange.H, 'G', 3, 64), "E", "*10^")

	k := strings.ReplaceAll(strconv.FormatFloat(cap.K, 'G', 3, 64), "E", "*10^")
	x := strings.ReplaceAll(strconv.FormatFloat(cap.X, 'G', 3, 64), "E", "*10^")
	...
	if capType == cap_model.CapData_flat {
		...
		lambda := strings.ReplaceAll(strconv.FormatFloat(cap.Lambda, 'G', 3, 64), "E", "*10^")
...
func (s *FormulasService) staticResistanceFormulas(
	...
	// перевод чисел в строки
	pressure := strconv.FormatFloat(req.Data.Pressure, 'G', 3, 64)
	axialForce := req.Data.AxialForce
	...
	if typeFlange == cap_model.FlangeData_free {
		...
		Dk := strconv.FormatFloat(flange.Ring.Dk, 'G', 3, 64)
...
func (s *FormulasService) conditionsForStrengthFormulas(
	...
	if flangeType == cap_model.FlangeData_free {
		fEpsilonK := strconv.FormatFloat(flange.Ring.Epsilon, 'G', 3, 64)
		fEpsilonKAt20 := strconv.FormatFloat(flange.Ring.EpsilonAt20, 'G', 3, 64)
...
func (s *FormulasService) tightnessLoadFormulas(
	...
	// перевод чисел в строки
	fAlpha1 := strings.ReplaceAll(strconv.FormatFloat(data.Flange.Alpha, 'G', 3, 64), "E", "*10^")
	fH1 := strconv.FormatFloat(data.Flange.H, 'G', 3, 64)
	fT1 := strconv.FormatFloat(data.Flange.T, 'G', 3, 64)
	fAlpha2 := strings.ReplaceAll(strconv.FormatFloat(data.Cap.Alpha, 'G', 3, 64), "E", "*10^")
	fH2 := strconv.FormatFloat(data.Cap.H, 'G', 3, 64)
	fT2 := strconv.FormatFloat(data.Cap.T, 'G', 3, 64)
	...
	if data.FlangeType == cap_model.FlangeData_free {
		fAlpha := strings.ReplaceAll(strconv.FormatFloat(data.Flange.Ring.Alpha, 'G', 3, 64), "E", "*10^")
