...
import (
	...
	"github.com/Alexander272/sealur/moment_service/internal/service/calc/cap_old/data"
	"github.com/Alexander272/sealur/moment_service/internal/service/calc/cap_old/formulas"
...
func (s *CapService) CalculationCapOld(ctx context.Context, data *calc_api.CapRequestOld) (*calc_api.CapResponseOld, error) {
	...
	if data.Calculation == calc_api.CapRequestOld_basis {
