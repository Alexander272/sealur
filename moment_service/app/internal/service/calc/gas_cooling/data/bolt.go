...
func (s *DataService) getBoltData(ctx context.Context, bolt *gas_cooling_model.BoltData, temp float64,
) (boltData *gas_cooling_model.BoltResult, err error) {
	boltData = &gas_cooling_model.BoltResult{
		Count: bolt.Count,
	}
