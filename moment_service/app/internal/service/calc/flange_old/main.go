...
import (
	...
	"github.com/Alexander272/sealur/moment_service/internal/service/calc/flange_old/data"
	"github.com/Alexander272/sealur/moment_service/internal/service/calc/flange_old/formulas"
...
func (s *FlangeService) CalculationFlangeOld(ctx context.Context, data *calc_api.FlangeRequest) (*calc_api.FlangeResponseOld, error) {
	...
	d, err := s.data.GetDataOld(ctx, data)
	if err != nil {
		return nil, err
	}
	...
	result := calc_api.FlangeResponseOld{
		...
		Flanges:      []*flange_model.OldFlangeResult{d.Flange1},
		Embed:        d.Embed,
		Gasket:       d.Gasket,
	}
