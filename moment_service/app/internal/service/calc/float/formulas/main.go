...
func (s *FormulasService) GetFormulas(
	...
	area := strings.ReplaceAll(strconv.FormatFloat(data.Bolt.Area, 'G', 5, 64), "E", "*10^")
	diameter := strconv.FormatFloat(data.Bolt.Diameter, 'G', 5, 64)
	Lb0 := strings.ReplaceAll(strconv.FormatFloat(result.Bolt.Lenght, 'G', 5, 64), "E", "*10^")
	typeBolt := strings.ReplaceAll(strconv.FormatFloat(s.typeBolt[TypeBolt], 'G', 5, 64), "E", "*10^")
	bEpsilonAt20 := strings.ReplaceAll(strconv.FormatFloat(data.Bolt.EpsilonAt20, 'G', 5, 64), "E", "*10^")
	bSigmaAt20 := strings.ReplaceAll(strconv.FormatFloat(data.Bolt.SigmaAt20, 'G', 5, 64), "E", "*10^")
	bSigma := strings.ReplaceAll(strconv.FormatFloat(data.Bolt.Sigma, 'G', 5, 64), "E", "*10^")
	count := data.Bolt.Count

	compression := strings.ReplaceAll(strconv.FormatFloat(data.Gasket.Compression, 'G', 5, 64), "E", "*10^")
	gEpsilon := strings.ReplaceAll(strconv.FormatFloat(data.Gasket.Epsilon, 'G', 5, 64), "E", "*10^")
	gThickness := strings.ReplaceAll(strconv.FormatFloat(data.Gasket.Thickness, 'G', 5, 64), "E", "*10^")
	gWidth := strings.ReplaceAll(strconv.FormatFloat(data.Gasket.Width, 'G', 5, 64), "E", "*10^")
	gM := strings.ReplaceAll(strconv.FormatFloat(data.Gasket.M, 'G', 5, 64), "E", "*10^")
	gPres := strings.ReplaceAll(strconv.FormatFloat(data.Gasket.Pres, 'G', 5, 64), "E", "*10^")
	gPermissiblePres := strings.ReplaceAll(strconv.FormatFloat(data.Gasket.PermissiblePres, 'G', 5, 64), "E", "*10^")

	fB := strings.ReplaceAll(strconv.FormatFloat(data.Flange.B, 'G', 5, 64), "E", "*10^")

	cY := strings.ReplaceAll(strconv.FormatFloat(data.Cap.Y, 'G', 5, 64), "E", "*10^")

	Dcp := strings.ReplaceAll(strconv.FormatFloat(data.Dcp, 'G', 5, 64), "E", "*10^")
	b0 := strings.ReplaceAll(strconv.FormatFloat(data.B0, 'G', 5, 64), "E", "*10^")
	pressure := strings.ReplaceAll(strconv.FormatFloat(math.Abs(result.Data.Pressure), 'G', 5, 64), "E", "*10^")
	Lb := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Lb, 'G', 5, 64), "E", "*10^")
	yp := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Yp, 'G', 5, 64), "E", "*10^")
	yb := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Yb, 'G', 5, 64), "E", "*10^")
	Po := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Po, 'G', 5, 64), "E", "*10^")
	A := strings.ReplaceAll(strconv.FormatFloat(result.Calc.A, 'G', 5, 64), "E", "*10^")
	alpha := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Alpha, 'G', 5, 64), "E", "*10^")
	Qd := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Qd, 'G', 5, 64), "E", "*10^")
	Rp := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Rp, 'G', 5, 64), "E", "*10^")
	Pb1 := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Pb1, 'G', 5, 64), "E", "*10^")
	Pb2 := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Pb2, 'G', 5, 64), "E", "*10^")
	Pb := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Pb, 'G', 5, 64), "E", "*10^")
	Pbr := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Pbr, 'G', 5, 64), "E", "*10^")
	dSigmaM := strings.ReplaceAll(strconv.FormatFloat(result.Calc.DSigmaM, 'G', 5, 64), "E", "*10^")
	Mkp := strings.ReplaceAll(strconv.FormatFloat(result.Calc.Mkp, 'G', 5, 64), "E", "*10^")
	...
	Kyp := strconv.FormatFloat(s.Kyp[IsWork], 'G', 5, 64)
	Kyz := strconv.FormatFloat(s.Kyz[Condition], 'G', 5, 64)
	Kyt := strconv.FormatFloat(constants.NoLoadKyt, 'G', 5, 64)
