...
func (r *FlangeRepo) GetTypeFlange(ctx context.Context, req *flange_api.GetTypeFlangeRequest) (typeFlange []models.TypeFlangeDTO, err error) {
...
func (r *FlangeRepo) CreateTypeFlange(ctx context.Context, typeFlange *flange_api.CreateTypeFlangeRequest) (id string, err error) {
...
func (r *FlangeRepo) UpdateTypeFlange(ctx context.Context, typeFlange *flange_api.UpdateTypeFlangeRequest) error {
...
func (r *FlangeRepo) DeleteTypeFlange(ctx context.Context, typeFlange *flange_api.DeleteTypeFlangeRequest) error {
...
func (r *FlangeRepo) GetStandarts(ctx context.Context, req *flange_api.GetStandartsRequest) (standarts []models.StandartDTO, err error) {
...
func (r *FlangeRepo) CreateStandart(ctx context.Context, stand *flange_api.CreateStandartRequest) (id string, err error) {
...
func (r *FlangeRepo) DeleteStandart(ctx context.Context, stand *flange_api.DeleteStandartRequest) error {
