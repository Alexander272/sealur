...
// func (h *SnpMaterialHandlers) GetAll(ctx context.Context, req *snp_material_api.GetAllSnpMaterials) (*snp_material_api.SnpMaterials, error) {
// 	materials, err := h.service.GetAll(ctx, req)
// 	if err != nil {
// 		return nil, err
// 	}

// 	return &snp_material_api.SnpMaterials{SnpMaterials: materials}, nil
// }
